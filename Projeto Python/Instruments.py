...
#     filtro = [
#         item for item in r.text.split('\n') if item.strip() != ''
#         if item["original_field_name"] in campos_interesse
#     ]
#     registro = r.json()
#     campos_filtrados = [campo for campo in registro if campo in campos_interesse]
#     print(json.dumps(campos_filtrados, indent=4, ensure_ascii=False))
# else:
#     campos_filtrados = []
...
# #Exportando o json
# with open('arquivos exportados\campos_interesse.json', 'w') as f:
#     json.dump(campos_filtrados, f, indent=4)
